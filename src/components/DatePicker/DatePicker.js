...
const datePickerThemes = {
    light: {
        ...
        bgSubtle: "bg.subtle",
        border: "border",
        borderInverted: "border.inverted",
        fg: "fg",
    },
    dark: {
        gray100: "gray.700",
...
// Генерация темы на основе colorPalette
const generateTheme = (mode, colorPalette) => ({
    ...
    color600: `${colorPalette}.600`,
    header: mode === "light" ? "white" : "gray.700",
    text: mode === "light" ? "gray.800" : "whiteAlpha.900",
    negativeText: "whiteAlpha.900",
    monthBackground: mode === "light" ? "white" : "gray.700",
    outsideDay: "#9f9696",
    bg: "bg",
    bgSubtle: "bg.subtle",
    border: "border",
...
const DatePicker = ({ 
    ...
    const dayContainer = {
        padding: 1.5,
        bg: datePickerTheme.bg,
        margin: 0,
    };
    const day = {
        ...getDayCellSize(datepickerSize),
        color: datePickerTheme.fg,
